...
void EXTI_SetEdgesEnable(u32 PinName, u8 RisingEnabled, u8 FallingEnabled) {
  ...
  RCC_APB2PeriphClockCmd(RCC_APB2Periph_SYSCFG, ENABLE); // Make sure SYSCFG clock is enabled before accessing it
...
void EXTI_SetEvent(u32 n, FunctionalState Enable) {
